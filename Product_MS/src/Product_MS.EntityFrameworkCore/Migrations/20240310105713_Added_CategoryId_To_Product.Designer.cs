...
{
    [DbContext(typeof(Product_MSDbContext))]
    [Migration("20240310105713_Added_CategoryId_To_Product")]
    partial class Added_CategoryId_To_Product
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Product_MS.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Product_MS.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Product_MS.Products.Product", b =>
                {
                    b.HasOne("Product_MS.Categories.Category", null)
                        .WithMany()
